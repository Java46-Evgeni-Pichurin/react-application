...
export const ROUTES:RouteType[] = [
    {path: COURSES_PATH, label: 'Courses', element: <Courses/>, authenticated: true, userRights: true},
    {path: ADD_COURSE_PATH, label: 'New Course', element: <AddCourse/>,authenticated: true},
    {path: STATISTIC_HOURS_PATH, label: 'Statistics Hours', element: <StatisticHours/>, authenticated: true, userRights: true},
    {path: STATISTIC_COST_PATH, label: 'Statistics Cost', element: <StatisticCost/>, authenticated: true, userRights: true},
    {path: LOGIN_PATH, label: 'Login', element: <Login/>},
    {path: LOGOUT_PATH, label: 'Logout', element: <Logout/>,authenticated: true, userRights: true},
