...
const Courses: React.FC = () => {
    ...
    function showUpdateConfirmation(course: Course) {
        ...
        confirmationData.current.title = 'Updating Course Confirmation'
    ...
    // const smallWidth = useMediaQuery('(min-width: 600px)');
    // const mediumWidth = useMediaQuery('(min-width: 900px)');
    // const largeWidth = useMediaQuery('(min-width: 900px)');
